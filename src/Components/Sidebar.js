        ...
        <div className='sidebar d-flex flex-column align-items-center p-3'>
            ...
            <ul className='list-unstyled p-2 w-100'>
                ...
                <li className='text-white w-100 p-1 rounded'>
                    ...
                    <Link to='/Entradas'>
                        <i className="bi bi-box-arrow-in-right me-4 fs-4 ps-2"></i>
                        <span className='fs-5'>Entradas</span>
                ...
                <li className='text-white w-100 p-1 rounded'>
                    <Link to='/Pedidos'>
                        ...
                        <i className="bi bi-bookmark-check me-4 fs-4 ps-2"></i>
                ...
                <li className='text-white w-100 p-1 rounded'>
                    <Link to='/Prueba'>
                        <i className="bi bi-box-seam me-4 fs-4 ps-2"></i>
                        <span className='fs-5'>Prueba</span>
                    </Link>
